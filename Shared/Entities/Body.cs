...
namespace Shared.Entities
{
    public class Body
    {
        public static Entity Create(string texturePath, Color color, string sound, Rectangle rectangle, string chain, Shared.Components.LinkPosition linkPos)
        {
            Entity body = new Entity();

            body.Add(new Shared.Components.Linkable(chain, linkPos, BodyLinking));
            body.Add(new Components.Appearance());
            body.Add(new Components.Renderable(color, Color.Black, rectangle, texturePath: texturePath));
