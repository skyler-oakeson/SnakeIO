...
namespace Shared.Entities
{
    public class MenuItem<T>
    {
                ...
                Rectangle rectangle)
        {
            ...
            menuItem.Add(new Shared.Components.Appearance());
            menuItem.Add(new Shared.Components.Readable(value != null ? value.ToString() : "UNDISPLAYABLE", Color.Orange, Color.Black, rectangle, font: font));
