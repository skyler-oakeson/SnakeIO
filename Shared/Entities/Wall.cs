...
namespace Shared.Entities
{
    public class Wall
    {
        public static Entity Create(string texture, string sound, Color color, Rectangle rectangle, string chain = null, Components.LinkPosition? linkPos = null)
        {
            ...
            wall.Add(new Components.Sound(sound));
