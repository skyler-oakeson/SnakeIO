...
namespace Systems
{
    ...
    /// </summary>
    public class InputHandler : Shared.Systems.System
    {
        KeyboardState statePrevious;
        Shared.Controls.ControlManager controlManager;

        public InputHandler(Shared.Controls.ControlManager controlManager)
            : base(
        ...
        /// are active.
        /// </summary>
        public void Update(Shared.Entities.Entity entity, TimeSpan elapsedTime)
        {
